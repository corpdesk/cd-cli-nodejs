...
export class CdAutoGitController {
  ...
  //     CdLogg.debug(
  //       'CdAutoGitController::getGitHubProfile()/encryptionMeta.iv:',
  //       { encryptIv: encryptionMeta?.iv },
  //     );
  ...
  //     try {
  //       // Cast encryptionMeta to include iv property
  //       gitProfileData.details.gitHubToken = await CdCliVaultController.decrypt(
  //         encryptionMeta as EncryptionMeta & { iv: string },
  //         encryptedValue,
  //       );
  //       CdLogg.debug(
  //         'CdAutoGitController::getGitHubProfile()/gitProfileData.details1:',
  //         gitProfileData.details,
  //       );
  //       if (!(await gitProfileData.details.gitHubToken)) {
  //         this.handleMissingToken();
  //       }
  //       CdLogg.debug(
  //         'CdAutoGitController::getGitHubProfile()/gitProfileData.details2:',
  //         gitProfileData.details,
  //       );
  //       gitProfileData.details.gitHubToken = await vaultItem.value;
  //       CdLogg.debug(
  //         'CdAutoGitController::getGitHubProfile()/gitProfileData.details3:',
  //         gitProfileData.details,
  //       );
  //     } catch (e) {
